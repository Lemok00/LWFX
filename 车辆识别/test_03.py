...
if __name__ == '__main__':
    ...
    TEST_MODEL_PATH = 'model/0309_densenet_70.pth'
    RESULT_PATH = 'result/result_0309_densenet_formzp.csv'
    BATCH_SIZE = 16
    ...
    for batch_idx, data in enumerate(test_loader, start=1):
        ...
        result[BATCH_SIZE * (batch_idx - 1):BATCH_SIZE * (batch_idx - 1) + len(y)] = y
